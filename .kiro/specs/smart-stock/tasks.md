...
- [x] 19.1 审计日志页面开发
  - [x] 19.1.1 创建 log.service.ts 前端服务
  - [x] 19.1.2 创建 useLogs.ts Hook
  - [x] 19.1.3 创建审计日志页面 (/logs)
  - [x] 19.1.4 实现日志表格展示
  - [x] 19.1.5 实现时间范围筛选
  - [x] 19.1.6 实现操作类型筛选
  - [x] 19.1.7 实现 SKU/操作人搜索
  - [x] 19.1.8 实现分页功能
  - [x] 19.1.9 实现 Excel 导出功能

## 20. 前端用户管理页面

- [x] 20.1 用户管理页面开发
  - [x] 20.1.1 创建 user.service.ts 前端服务
  - [x] 20.1.2 创建 useUsers.ts Hook
  - [x] 20.1.3 创建用户管理页面 (/users)
  - [x] 20.1.4 实现用户表格展示
  - [x] 20.1.5 创建 UserForm.tsx 用户表单组件
  - [x] 20.1.6 实现新建用户功能
  - [x] 20.1.7 实现编辑用户功能
  - [x] 20.1.8 实现禁用/启用用户功能
  - [x] 20.1.9 实现删除用户功能

## 21. 库存预警功能

- [x] 21.1 预警功能实现
  - [x] 21.1.1 创建 alert.store.ts (Zustand) - 已在 stores/index.ts 中实现 useAlertStore
  - [x] 21.1.2 实现登录后低库存检查 - 已在 dashboard 页面实现
  - [x] 21.1.3 实现低库存弹窗提醒 - 已实现 LowStockAlertModal 组件
  - [x] 21.1.4 实现"查看详情"跳转 - 已实现跳转到 /products?lowStock=true
  - [x] 21.1.5 实现"稍后提醒"功能 - 已实现 sessionStorage 记录 dismiss 状态
